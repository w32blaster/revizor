...
<div class="btn-group pull-right">
   ...
   <a href="${urlPrefix}/${Constants.REVIEW_SINGLE_VIEW}?${Constants.PARAM_FILE_NAME}=${params[Constants.PARAM_FILE_NAME]}"
   ...
   <a href="${urlPrefix}/${Constants.REVIEW_SIDE_BY_SIDE_VIEW}?${Constants.PARAM_FILE_NAME}=${params[Constants.PARAM_FILE_NAME]}"
